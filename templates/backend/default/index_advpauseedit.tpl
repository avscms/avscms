			...
			<div class="col-md-12">
				<div class="grid simple">
					<div class="grid-title no-border">
						<h4>Edit <span class="semi-bold">In-Player Pause Ad</span></h4>
					</div>
					<div class="grid-body no-border">
						<form class="form-no-horizontal-spacing" name="add_adv" method="POST" enctype="multipart/form-data" action="index.php?m=advpauseedit&AID={$adv.id}">
							<div class="row">
								<div class="col-lg-6 col-lg-offset-3 col-md-12">					
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<textarea name="adv_code" rows="6" class="form-control {if $err.code}error{/if}" style="resize: vertical">{$adv.code}</textarea>
										</div>	
										<div class="clearfix"></div>
									</div>	
