			...
			<div class="col-md-12">
				<div class="grid simple">
					<div class="grid-title no-border">
						<h4>Add <span class="semi-bold">In-Player Pause Ad</span></h4>
					</div>
					<div class="grid-body no-border">
						<form class="form-no-horizontal-spacing" name="add_adv" method="POST" enctype="multipart/form-data" action="index.php?m=advpauseadd">
							<div class="row">
