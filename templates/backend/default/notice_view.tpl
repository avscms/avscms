	...
	<div id="viewModalDialog" class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 id="viewModalLabel" class="semi-bold">Notice <span id="view-id-span"></span>: View</h4>
			</div>
				...
				<div class="row">									
					...
					<div class="col-xs-12">
						<div class="video-wrapper">
							<iframe id="view-notice-container" src="" frameborder="0" scrolling="no" allowfullscreen></iframe>
						</div>
					</div>
				</div>
			</div>
			<div class="modal-footer">
				...
				<div class="pull-right">
					...
					<ul class="dropdown-menu">
						<li><a id="view_del_notice" data-id="" href="#">Confirm Delete</a></li>
					</ul>
				</div>
			</div>
		</div>	 
