			...
			<div class="col-md-12">
				<div class="grid simple">
					<div class="grid-title no-border">
						<h4>Add h264<span class="semi-bold">Encoding</span></h4>
					</div>
					<div class="grid-body no-border">
						<form class="form-no-horizontal-spacing" name="add_adv" method="POST" action="index.php?m=encodingadd">
							<div class="row">
							...
							<div class="form-actions">
								<div class="pull-right">
									<input type="submit" name="encoding_add" value="Add" class="btn btn-success btn-cons">
