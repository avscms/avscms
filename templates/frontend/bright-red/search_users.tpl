<div class="container mt-3 mb-3">
	...
	<div class="well-filters">
			<div class="float-left">
				<h1>{t c='search.title'}<span class="d-none d-md-inline"> - {t c='global.users'}</span></h1>
			</div>
				...
				<div class="d-none d-md-inline">
					<div class="btn-group m-r-10">
						...
						<ul class="dropdown-menu">
							<li {if $interest == ''}class="active"{/if}><a href="{url base='search/users' strip='i' value=''}">{t c='global.any'}</a></li>
							<li {if $interest == 'Guys'}class="active"{/if}><a href="{url base='search/users' strip='i' value='Guys'}">{t c='global.guys'}</a></li>
							<li {if $interest == 'Girls'}class="active"{/if}><a href="{url base='search/users' strip='i' value='Girls'}">{t c='global.girls'}</a></li>
							<li {if $interest == 'Guys + Girls'}class="active"{/if}><a href="{url base='search/users' strip='i' value='Guys%2BGirls'}">{t c='global.guys_girls'}</a></li>
						</ul>
					</div>
					...
					<div class="btn-group m-r-10">
						...
						<ul class="dropdown-menu">
							<li {if $avatar == ''}class="active"{/if}><a href="{url base='search/users' strip='a' value=''}">{t c='global.any'}</a></li>							
							<li {if $avatar == 'yes'}class="active"{/if}><a href="{url base='search/users' strip='a' value='yes'}">{t c='avatar.yes'}</a></li>
							<li {if $avatar == 'no'}class="active"{/if}><a href="{url base='search/users' strip='a' value='no'}">{t c='avatar.no'}</a></li>
						</ul>
					</div>					
					...
					<div class="btn-group m-r-10">
						...
						<ul class="dropdown-menu">
							<li {if $order == 'mr'}class="active"{/if}><a href="{url base='search/users' strip='o' value='mr'}">{t c='global.most_recent'}</a></li>
							<li {if $order == 'mv'}class="active"{/if}><a href="{url base='search/users' strip='o' value='mv'}">{t c='global.most_viewed'}</a></li>
							<li {if $order == 'ma'}class="active"{/if}><a href="{url base='search/users' strip='o' value='ma'}">{t c='global.most_active'}</a></li>
							<li {if $order == 'mp'}class="active"{/if}><a href="{url base='search/users' strip='o' value='mp'}">{t c='global.most_popular'}</a></li>
							<li {if $order == 'tr'}class="active"{/if}><a href="{url base='search/users' strip='o' value='tr'}">{t c='global.top_rated'}</a></li>
							<li {if $order == 'on'}class="active"{/if}><a href="{url base='search/users' strip='o' value='on'}">{t c='global.online_now'}</a></li>
						</ul>
					</div>
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li {if $gender == ''}class="active"{/if}><a href="{url base='search/users' strip='g' value=''}">{t c='global.any'}</a></li>							
							<li {if $gender == 'Male'}class="active"{/if}><a href="{url base='search/users' strip='g' value='Male'}">{t c='global.male'}</a></li>
							<li {if $gender == 'Female'}class="active"{/if}><a href="{url base='search/users' strip='g' value='Female'}">{t c='global.female'}</a></li>
						</ul>
					</div>						
				</div>	
