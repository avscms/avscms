<div class="container mt-3 mb-3">
	<div class="well-filters">
			<div class="float-left">
				<h1>{t c='search.title'}<span class="d-none d-md-inline"> - {t c='global.photos'}</span></h1>
			</div>
	...
	<div class="row">
		...
		<div class="content-right mb-3">
			<div class="list-group mb-3">
				<a href="{url base='search/photos/'|cat:$search_query strip='c' value=''}" {if $category == "0"}class="list-group-item active"{else}class="list-group-item"{/if}>
					{t c='global.all'}
				</a>
				{section name=i loop=$categories}
				<a href="{url base='search/photos/'|cat:$search_query|cat:'/'|cat:$categories[i].slug strip='c' value=''}" {if $category == $categories[i].CID}class="list-group-item active"{else}class="list-group-item"{/if}>
					{$categories[i].name}
				</a>
				{/section}
			</div>
