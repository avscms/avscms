...
<div class="container mt-3 mb-3">
	...
	<div class="row">
		...
		<div class="col-12">
			<div class="card-sub">
				...
				<span class="d-block d-sm-none float-right mb-3"><span class="text-highlighted"><i class="fas fa-eye"></i> {$blog.total_views}</span> &nbsp; {$addtime}</span>				
				<div class="clearfix"></div>			
				<div class="float-left">
					<a href="{$relative}/user/{$user.username}"><img class="medium-avatar" src="{$relative}/media/users/{if $user.photo == ''}nopic-{$user.gender}.gif{else}{$user.photo}{/if}" /><span>{$username|truncate:25:"..."}</span></a>
				...
				<div class="float-right mt-2">
					<span class="d-none d-sm-inline"><span class="text-highlighted"><i class="fas fa-eye"></i> {$blog.total_views}</span> &nbsp; {$addtime}</span>					
	...
	{if $blog_comments == '1'}
		...
		<div class="comments-section mt-3">
			...
			{assign var="comment_section" value="blog"}
			<div class="well-filters mb-1">
				...
				<div class="float-left">
					<h1>
						<a id="comments_sort" href="#" data-id="{$blog.BID}" data-type="{$comment_section}" data-sort="newest" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-sort-amount-down"></i></a>
			...
			<div id="comments_input_container">
				<textarea data-id="{$blog.BID}" data-type="{$comment_section}" id="comments_input" rows="3"  maxlength="1000" class="form-control" {if !isset($smarty.session.uid)}disabled{/if}></textarea>
			...
			{if $comments_total > 10}
				<a href="#" id="comments_show_more" class="comments-show-more" data-page="2" data-type="{$comment_section}" data-id="{$blog.BID}">{t c='global.show_more'}<i class="fas fa-chevron-down"></i></a>
	...
	{insert name=adv assign=adv group='blog_bottom'}
	{if $adv.ad}		
	...
	{elseif $adv.help}		
		<div class="ad-body">
			<p class="ad-title"><span>{t c='global.sponsors'}</span><span class="ad-group">BLOG BOTTOM</span></p>
